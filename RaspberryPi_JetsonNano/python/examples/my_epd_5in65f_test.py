...
# GPIO configuration and installation instructions
# https://www.waveshare.com/wiki/5.65inch_e-Paper_Pi
...
#     time.sleep(3)
    ...
    Himage = Image.open(os.path.join(picdir, 'IMG_3877.jpeg'))
    new_image = Himage.resize((600, 448))
